...
> Синхронизировано с релизом **`v0.2.106`** (fuel compensation v2 GPS eligibility, GPS filter 150m/15m/150kmh): NP **IntegrationSetting** + UI **`/settings/nova-poshta`**; Google Drive в **Settings → Google-таблиця**; companies create (name-only, auto owner); rewrite путей прокси NP → upstream.
