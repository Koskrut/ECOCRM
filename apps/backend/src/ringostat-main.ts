/**
 * Standalone Ringostat worker (`ringostat-runner` in Dockerfile).
 */
...
class RingostatRootModule {}

async function bootstrap() {
  const app = await NestFactory.create(RingostatRootModule, { rawBody: true });
  ...
  console.log(`Ringostat worker listening on http://localhost:${port}`);
}
