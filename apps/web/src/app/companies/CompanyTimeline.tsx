  ...
  return (
    <div className="flex h-full flex-col rounded-lg border border-zinc-200 bg-white shadow-sm">
      <div className="border-b border-zinc-200 p-4">
        ...
        <div className="mt-3">
          <textarea className="w-full rounded-md border border-zinc-200 p-2 text-sm outline-none focus:ring-2 focus:ring-zinc-200" rows={3} placeholder={mode === "CALL" ? "Коротко: о чём был звонок?" : mode === "MEETING" ? "Коротко: итоги встречи?" : "Написать комментарий..."} value={text} onChange={(e) => setText(e.target.value)} />
