  ...
  return (
    <div className="min-w-0 space-y-6">
      ...
      <div className="rounded-xl border border-amber-200/70 bg-amber-50/30 p-4 text-sm text-amber-950/90">
        <p className="font-medium text-zinc-900">Операційний знімок</p>
        <p className="mt-1 text-zinc-700">
          Списки та лічильники тут — поточний backlog у межах обраного менеджера / команди. Вони{" "}
          <strong>не</strong> фільтруються датами періоду зверху і <strong>не</strong> змінюються від прапорця
          «Порівняти з попереднім періодом» (параметр лишається в URL для навігації між вкладками).
        </p>
      </div>
      ...
      <section id="overdue-tasks" className="scroll-mt-24 space-y-2">
        ...
        <p className="text-xs text-zinc-500">Operational snapshot · OPEN/IN_PROGRESS, dueAt &lt; зараз.</p>
        <SimpleTable
      ...
      <section id="stuck-orders" className="scroll-mt-24 space-y-2">
        ...
        <p className="text-xs text-zinc-500">Operational snapshot · без руху стадії &gt; 3 дні (логіка сервісу).</p>
        <SimpleTable
      ...
      <section id="leads-without-touch" className="scroll-mt-24 space-y-2">
        ...
        <p className="text-xs text-zinc-500">Operational snapshot · узгоджено з overview CRM count (Activity-based).</p>
        <SimpleTable
      ...
      <section id="finance-overdue" className="scroll-mt-24 space-y-2">
        ...
        <p className="text-xs text-zinc-500">Operational snapshot · OVERDUE + debt &gt; 0.</p>
        <SimpleTable
