export const en = {
  ...
  settings: {
    ...
    cards: {
      ...
      inboxTemplates: {
        title: "Inbox reply templates",
        desc: "Canned responses for managers in Telegram / Instagram / Facebook",
      },
      metaMessaging: {
  ...
  planning: {
    ...
    actions: {
      ...
      addFactoryLine: "Add line",
      removeFactoryLine: "Remove",
      addToDraft: "Add to draft",
      cancelFactoryDraft: "Cancel draft",
      markPackingComplete: "Done",
      open: "Open",
      selectBatch: "Select batch",
      recalculateMrp: "Recalculate MRP",
      goPack: "Pack",
      goProduction: "To production",
      goFactory: "To factory",
      exportCsv: "Export CSV",
      showBreakdown: "Details",
      hideBreakdown: "Hide",
      reopenPacking: "Back to draft",
      deletePacking: "Delete request",
      deleteFactoryOrder: "Delete draft",
    },
    confirm: {
      deletePacking: "Delete this packing request? This cannot be undone.",
      deletePackingLine: "Remove this line from the request?",
      reopenPacking: "Return this request to draft so you can edit it?",
      deleteFactory: "Delete this factory draft? This cannot be undone.",
    },
    overview: {
      ...
      openFactoryDrafts: (n: number) => `Factory drafts (${n}) →`,
      noZeroStock: "No zero-stock positions in the snapshot",
      noParetoZero: "No zero stock among top-80% revenue SKUs",
      paretoCol: "Top 80%",
      inPareto80: "Yes",
      kindKit: "Kit",
      kindPart: "Part",
    ...
    labels: {
      ...
      maxBuildNow: "Can build from parts",
      maxBuildNowHint:
      ...
      minPackLot: "Min pack lot",
      minProduceLot: "Min produce lot",
      ...
      trackingDueSoon: "Due soon",
      trackingOverdue: "Overdue",
      overdueLinesCount: "Overdue lines",
      nearestLineDue: "Nearest due",
      factoryTracking: "Delivery tracking",
      qtyReceived: "Received",
      searchPart: "Search part (SKU / name)…",
      addPartQty: "Qty",
      needQty: "Gap / need",
      kitNeed: "Kits needed",
      partGap: "Part gap",
      ...
      awaitingStockHint:
        "Current orders in Awaiting stock status — not the MRP horizon. Shows finished kits from 1C and how many can be assembled from parts.",
      awaitingStockSummary: (skuCount: number, orderCount: number, totalQty: number) =>
        `${skuCount} SKUs / ${orderCount} orders / ${totalQty} pcs`,
      showOrders: "Show orders",
      hideOrders: "Hide orders",
      onStock: "On stock",
      finishedOnStock: "Finished (1C)",
      finishedGap: "Missing finished",
      canAssembleFromParts: "Can assemble",
      ordersCount: "Orders",
    },
    filters: {
      all: "All",
    ...
    kitBoms: {
      ...
      cycleNeedHint: "Friday packing-cycle need (same as the request)",
      idealCol: "Ideal",
      idealHint: "Cover-norm stock (~MRP warn cover days)",
      stockCol: "Stock",
      canPackIdeal: "Can pack to ideal",
      produceIdeal: "Produce to ideal",
      canPackCycle: "Can pack (cycle)",
      toWorkCycle: "To work (cycle)",
      alreadyInRequest: "In request",
      stockFinished: "Finished (snapshot)",
      weeksCover: "Weeks of cover",
      priceCol: "Price",
      linesCount: "Components",
      effectiveFrom: "Effective from",
      scrap: "Scrap %",
      filterDeficit: "Deficit to ideal",
      addToPack: "Add to pack",
      orderBottleneck: "Order part",
      belowMinPack: (n: number) => `Below min pack lot (${n})`,
      produceLotHint: (raw: number, lot: number) =>
        raw < lot ? `raw gap ${raw} → lot ${lot}` : null,
    },
    sheet: {
      hint: "Spreadsheet view: kit row → BOM expand (parts and fasteners). Packing writes the cycle draft; «+» creates a production batch.",
      ...
      colSku: "SKU",
      colGp: "FG",
      colWipKits: "Kits in WIP",
      colParts: "Parts",
      colPartStock: "FG (parts)",
      colPartWip: "Parts in WIP",
      colFasteners: "Fasteners",
      colQty: "Qty",
      colCover2m: "Per 2 mo / MOC",
      colCover: "MOC",
      colSalesYear: "Sales / year",
      colPack: "Pack kit",
      colProduce: "Produce",
      savePack: "OK",
      produceHint: "Create a batch for the entered qty",
      toFactory: "To factory",
      bottleneck: "bottleneck",
      expand: "Expand",
      collapse: "Collapse",
      expandAll: "Expand all",
      collapseAll: "Collapse all",
      bulkPack: "Create packing request (selected)",
      bulkProduce: "Send to production (selected)",
      deficitHint: (sku: string) => `Deficit / bottleneck: ${sku}`,
      deficitZeroStock: "Zero stock on parts",
      presetHint: "Quick values",
      selectAll: "Select all visible",
      selectRow: "Select row",
      freshnessCompactOk: "Stock & demand are fresh",
      freshnessCompactWarn: "Refresh data",
      freshnessStockShort: "Stock",
      freshnessDemandShort: "Demand",
      freshnessMrpShort: "MRP",
    },
    productParams: {
      title: "SKU parameters",
      hint: "Per-SKU MRP knobs. ABC×XYZ come from CRM shipments; a monthly override switches demand to MANUAL.",
      classCol: "Class",
      modeCol: "Mode",
      overrideCol: "Override / mo",
      leadCol: "Lead days",
      plannedCol: "Planned",
    },
    placeholders: {
    ...
    states: {
      ...
      ok: "OK",
      noSales: "None",
      nothingBurning: "Nothing critical — check data and MRP",
      none: "none",
    ...
    messages: {
      ...
      factoryHint:
        "Build a factory-order draft, add/remove lines, set per-part delivery dates from production, then approve. After approval enter the 1C code, track overdue lines, and record receipts.",
      salesHistoryHint:
    ...
    kitBoard: {
      ...
      classHintAx: "AX — stable revenue driver",
      classHintAz: "AZ — important but volatile → check manual override in Data",
      matrixTitle: "ABC×XYZ matrix",
      search: "Name or SKU",
    ...
    errors: {
      ...
      fileTooLarge:
        "File is too large to upload. Try a smaller file or contact your administrator.",
      ...
      loadBoms: "Failed to load BOM list",
    },
    stages: {
      MECH: "Machining",
      DEGREASE: "Degreaser",
  ...
  payments: {
    ...
    deleteCashPayment: "Delete",
    deleteCashPaymentConfirm: (orderNumber: string, amount: string) =>
      `Delete cash payment ${amount} for order ${orderNumber}?`,
    usdFxVarianceWarning: "USD amount differs from the rate by more than 1%",
  ...
  receivables: {
    ...
    promisedTodayOnly: "Promised today",
    ...
    promiseAmount: "Promised amount",
    copyPayLink: "Copy pay link",
    payLinkCopied: "Link copied",
    payLinkMissing: "No pay link yet — opening the order",
    searchByCode: "Search this 1C code",
    agingAll: "All ages",
    aging0to7: "0–7 days",
    ...
    aging90plus: "90+ days",
    aging30plus: "30+ days",
    overdueDaysShort: (n: number) => `${n}d overdue`,
    deltasOnly: "Discrepancies only",
    reconcileDeltaOnly: "1C discrepancies only",
    delayReasonAll: "All reasons",
    delayReasonWaitingAct: "Waiting for act signing",
    delayReasonClientDelay: "Client delaying payment",
    delayReasonDispute: "Goods dispute",
    delayReasonOther: "Other",
    colDelayReason: "Reason",
    delayReasonLabel: "Overdue reason",
    selectAll: "Select all",
    selectRow: "Select",
    moreActions: "More actions",
    remindAction: "Remind",
    remindTitle: "Client reminder",
    reminderTplPayment: "Payment due",
    reminderTplPayLink: "Pay link",
    reminderTplBroken: "Broken promise",
    reminderBodyPayment:
      "Hello, {clientName}! Reminder about outstanding balance {amount}. Please settle the invoice.",
    reminderBodyPayLink:
      "Hello, {clientName}! Amount due: {amount}. Pay link: {payLink}",
    reminderBodyBroken:
      "Hello, {clientName}! The promised payment date has passed. Balance: {amount}. Please confirm a new date.",
    reminderCopy: "Copy",
    reminderSendTelegram: "Telegram",
    reminderOpenInbox: "Inbox",
    reminderCopied: "Text copied",
    reminderSentTelegram: "Sent via Telegram",
    reminderTelegramMissing: "No Telegram conversation with this client",
    batchSelected: (n: number) => `Selected: ${n}`,
    batchRemind: "Reminders",
    batchCallTasks: "Call tasks",
    batchPickManager: "Manager…",
    batchAssign: "Assign",
    batchClear: "Clear",
    batchTasksCreated: (n: number) => `Tasks created: ${n}`,
    batchAssigned: (n: number) => `Manager assigned: ${n}`,
    batchTelegramResult: (ok: number, skip: number) =>
      `Telegram: sent ${ok}, no channel ${skip}`,
    agingWidgetTitle: "Receivables aging",
    agingWidgetSubtitle: "Overdue debt by age buckets",
    agingWidgetEmpty: "No overdue debt for the chart",
    filterShowDeltas: "Show 1C discrepancies",
    ...
    expandOrders: "Orders",
    expandPayments: "Payments",
    periodPaymentsTitle: "Payments in period",
    periodPaymentsFrom: "From",
    periodPaymentsTo: "To",
    periodPaymentsApply: "Apply",
    noPeriodPayments: "No payments in this period",
  ...
  dashboard: {
    ...
    manager: {
      ...
      inbox: {
        ...
        allClear: "All clear",
        prioritizedHint: "Biggest risks first.",
        tiles: {
      ...
      scorecard: {
        ...
        activityDetailTitle: "Activity for period",
        activityHint:
          "Month pulse is always from the 1st. Here — rolling 7/30 days for calls, visits and leads.",
        activityPeriodLabel: "Activity period",
        rollingWeek: "Last 7 days",
        rollingMonth: "Last 30 days",
        ...
        tooltips: {
          wonShare: "Share of WON among closed leads (WON+LOST) for the selected rolling period.",
          exactConversion: "Share of leads that converted to orders in the period.",
        },
        todayLabel: "Today",
        periodLabel: "Period",
      },
      monthPulse: {
        title: "Month pulse",
        subtitle: "From the 1st — where you stand vs last month’s pace.",
        dayProgress: "Day {elapsed} of {total}",
        shippedClients: "Shipped clients",
        ofBase: "of {base} in your base",
        coverage: "Base coverage",
        unshipped: "Still not shipped",
        vsPace: "vs same days last month",
        vsFull: "full last month: {value}",
        bookedRevenue: "Booked revenue",
        collectedPayments: "Payments",
        conversion: "Conversion",
        forecast: "Month-end forecast",
        forecastHint: "Linear pace from MTD — a guide, not a target.",
        tooltips: {
          shipped:
            "Unique owned clients with an order moved to Shipped in the calendar month (Kyiv).",
          coverage: "Shipped / all contacts you own. Each client counts once.",
          pace: "Compared to the 1st–same day of last month, not the full month.",
          forecast: "MTD ÷ days elapsed × days in month.",
          conversion: "Share of leads converted to orders since the 1st of this month.",
        },
      },
      growthLevers: {
        title: "Where I’m behind",
        subtitle: "Priority signals — worst first.",
        empty: "No major gaps right now. Keep the pace.",
        financeHidden: "Finance signals are hidden (Finance module off).",
        vsCompare: "vs {value}",
        status: {
          good: "OK",
          watch: "Watch",
        ...
        keys: {
          ...
          overdue: "Overdue follow-ups & tasks",
        },
        action: "Open",
      },
      trend: {
        title: "Month trend",
        subtitle: "This month vs last month (by day).",
        booked: "Revenue",
        collected: "Payments",
        shipped: "Clients shipped",
        current: "This month",
        previous: "Last month",
      ...
      potential: {
        title: "Potential",
        subtitle: "Where you can still push before month end.",
        unshipped: "Not shipped this month",
        overdueFollowups: "Overdue follow-ups",
        hotLeads: "Leads in progress",
        openPipeline: "Debt in open pipeline",
        openOrders: "{count} orders",
        viewQueue: "To queue",
        nearestQueue: "Nearest attention queue",
        viewLeads: "To leads",
        viewOrders: "To orders",
      },
      pipeline: {
  ...
  leads: {
    pageTitle: "Leads",
    pageSubtitle: "Inbound inquiries and potential customers",
    addLead: "+ Lead",
    newLead: "New lead",
    searchPlaceholder: "Search by name, phone, email, company, city…",
    searchAriaLabel: "Search leads",
    filtersTitle: "Lead filters",
    ...
    close: "Close",
    loading: "Loading…",
    totalLine: "Total: {total} · Page {page} of {totalPages}",
    pageLine: "Page {page} of {totalPages} • Total {total}",
    pageShort: "Page {page}/{totalPages}",
    previous: "Previous",
    next: "Next",
    emptyTitle: "No leads yet",
    emptyHint: "Create the first lead to get started",
    emptyFilteredTitle: "Nothing found",
    emptyFilteredHint: "Try changing filters or the search query",
    fromPlan: "Selected from plan",
    scoreTooltip: "Meta form score (typically 0–7)",
    columns: {
    ...
    attention: {
      "without-touch": "Leads without touch",
      "never-contacted-new": "New without first contact",
      "stale-in-progress": "Stuck in progress",
    },
    sortBy: {
    ...
    sortOrder: {
      descNewest: "Newest first",
      ascOldest: "Oldest first",
      descHigh: "Highest first",
      ascLow: "Lowest first",
    },
    filterLabels: {
      status: "Status",
    ...
    create: {
      ...
      companyPlaceholder: "Name from form or call",
      source: "Source",
  ...
  tasks: {
    ...
    errors: {
      ...
      loadOneFailed: "Failed to load task",
    ...
    empty: {
      ...
      noMatchHint: "Reset filters or create a new task.",
      noTasks: "No tasks yet.",
      noActive: "No active tasks.",
      noOpen: "No open tasks.",
      myQueue: "Your queue is empty.",
      myQueueHint: "Create the first task to get started.",
    },
  ...
  contacts: {
    ...
    card: {
      ...
      kpi: {
        ...
        debt: "Debt",
        overdue: "Overdue",
        overdueAlertTitle: "Overdue receivables",
        overdueAmount: "Overdue",
        clientTotalDebt: "Client total debt",
      ...
      orders: {
        expand: "Expand order movement",
        collapse: "Collapse order movement",
        finance: "Finance",
        payments: "Payments",
        returns: "Returns",
        ...
        noChildren: "No child orders",
        paymentsOnParent: "Payments are on parent #{number}",
        returnAdjustment: "Return credit",
        openReturns: "Open return",
        paid: "Paid",
        debt: "Debt",
        ...
        paymentsChip: "Payments · {count}",
        returnsChip: "Returns · {count}",
        childrenChip: "Children · {count}",
  ...
  visitsRouteMap: {
    layerPlan: "Plan",
    layerPlanAllStops: "Plan (all stops)",
    layerFactGps: "GPS fact",
    ...
    pathHiddenBadge: "map hidden",
    mapUnavailable: "Google Maps unavailable",
    loading: "Loading…",
    gpsPoints: (n: number) => `GPS points: ${n}`,
    coverage: (pct: number) => ` · coverage ${pct}%`,
    trackTruncated: " · track ended before last visit",
    gpsGaps: " · GPS track gaps",
    weakGps: " · weak GPS",
  ...
  visitsFuelPage: {
    ...
    compensationVisits: "by visits, incomplete track",
    compensationPlanned: "by plan",
    compensationPlannedPartial: "by plan ({confirmed} of {plan} stops)",
    plannedExpected: "expected {km} km",
    loopCollapseBadge: " · loop collapse",
    trackSnapKm: "Track (snap)",
    trackRawKm: "raw",
    visitsKm: "Visits",
    gpsDisplayOnly: "for review, not payout",
    gpsSnapFailed: "by visits, GPS did not snap",
    gpsSnapFailedShort: "GPS did not snap",
    plannedPayoutKpi: "Plan (payout)",
    plannedSeparateKpi: "Plan (separate)",
    mobilityTitle: "Travel mode",
    mobilityCar: "Car",
    ...
    warnings: {
      visit_no_coordinates: "Visit missing coordinates",
      visit_gps_review: "Visit GPS under review",
      gps_low_coverage: "Low GPS coverage",
      gps_low_coverage_partial_payout: "Low GPS coverage — partial payout",
      ...
      plan_without_completed_visits: "Plan exists but no completed visits — not paid",
      non_vehicle_day: "Non-vehicle day (walk / transit) — fuel not paid",
      ...
      planned_order_inefficient: "Plan order inefficient vs same visit stops",
      route_anchors_not_configured: "Route anchors not configured",
      metrics_unavailable: "Metrics unavailable",
      fuel_price_missing_for_uah_estimate: "Fuel price missing for UAH estimate",
      gps_ended_before_last_visit: "GPS ended before last visit",
      gps_implausibly_short_vs_visits: "GPS too short vs visits",
      gps_implausibly_long_vs_visits: "GPS too long vs visits",
      gps_track_too_short: "Track too short",
      gps_track_degraded: "Track degraded",
  ...
  visitsPage: {
    ...
    routeSource: {
      ...
      rawGps: "GPS off-road",
      plannedFallback:
        "Planned route is approximate — OSRM is unavailable. Check the osrm service / GET /system/routing-health.",
    ...
    routeConfirm: {
      stepSave: "1/3 Save the visit order",
      stepReview: "2/3 Review the road route on the map and confirm",
      stepReady: "3/3 Route confirmed — you can start the day",
      needsReconfirm: "Order changed — save and confirm again",
      confirm: "Confirm route",
      confirming: "Confirming…",
      confirmed: "Route confirmed",
      startNeedsConfirm: "Save and confirm the route first",
      confirmSuccess: "Route confirmed",
      confirmFailed: "Could not confirm the route",
      confirmDisabledOsrm: "Confirmation is available only for a road-following (OSRM) route",
    },
  },
  visitLocation: {
  ...
  visitsTeam: {
    ...
    onShift: "On shift",
    mobilityWalkTransit: "Walk / transit",
    ...
    badgeApp: "App",
    badgeGps: "GPS",
    badgeTrackingHealth: "Tracking health",
    trackingHealthHealthy: "Tracking OK",
    trackingHealthNetworkDegraded: "Network degraded",
    trackingHealthLocationStale: "GPS stale",
    trackingHealthServiceDead: "Service stopped",
    trackingHealthRecoveryInProgress: "Recovering…",
    trackingHealthRecoveryFailed: "Recovery failed",
    ...
    trackingSourceUnknown: "unknown source",
    appVersionUnknown: "unknown version",
    trackingBuildDetail: "{version} · {source}",
    trackingBuildDetailWithDevice: "{version} · {source} · {device}",
    trackingLegacyAlert: "app update required",
  ...
  returns: {
    ...
    statusInTransitBack: "In transit back",
    statusReceivedByWarehouse: "Received at warehouse",
    statusInspection: "Inspection",
    statusRefundOrAdjustment: "Refund or adjustment",
    statusClosed: "Closed",
