export const en = {
  ...
  planning: {
    ...
    labels: {
      ...
      targetPack: "Pack target",
      partsBlockedHint: "Missing parts for target qty",
      product: "Product",
      sku: "SKU",
      name: "Name",
      qty: "Qty",
  ...
  visitsRouteMap: {
    ...
    layerFactVisits: "Fact (visits)",
    layerFactGps: "Fact (GPS)",
    layerFactVisitsGps: "Fact (GPS+visits)",
    noData: "No route data for this day.",
    loading: "Loading route…",
    mapUnavailable: "Map unavailable (no Google Maps API key)",
    openLiveTeam: "Open live team map",
    kpiPlan: "Plan",
    kpiFactGps: "Fact GPS",
    kpiFactVisits: "Fact (visits)",
    deviation: "deviation",
    incompleteTourFootnote:
      "GPS shows the path so far; visits include the full return tour. Plan deviation may look low until the shift ends.",
    stopN: (n: number) => `Stop ${n}`,
    gpsPoints: (n: number) => `GPS: ${n} points`,
    coverage: (pct: number) => ` · coverage ${pct}%`,
    trackTruncated: " · track ended early",
    gpsGaps: " · GPS with gaps",
    weakGps: " · weak GPS signal",
    compensationGps: " · payout: GPS",
    compensationHybrid: " · payout: GPS+visits",
    compensationReview: " · payout: review",
    compensationVisits: " · payout: visits",
    loopCollapseReview: " · loop collapse — review required",
    sourceOsrmMatch: "osrm_match",
    sourceOsrmMatchGaps: "osrm_match · gaps",
    sourceOsrmRoute: "osrm_route",
    sourceApprox: "approximate",
    sourceRawGps: "GPS off-road",
    sourceNone: "none",
  },
  visitsFuelPage: {
    compensationGps: "GPS track (osrm_match)",
    compensationHybrid: "GPS+visits (hybrid)",
    compensationReview: "review — no auto payout",
    compensationVisits: "visit order",
    ...
    warnings: {
      insufficient_completed_visits:
        "Complete at least 2 visits with map coordinates to calculate distance.",
      visit_no_coordinates: "Visit without coordinates — not in route.",
      visit_gps_review: "GPS warning on visit — manager may review.",
      metrics_unavailable: "Could not calculate route distance.",
      route_anchors_not_configured:
        "Start/end not set in profile (Employees → Visit route). Distance uses first and last visit.",
      gps_track_degraded: "Weak GPS track — payout uses completed visit order.",
      gps_track_too_short: "GPS track under 0.5 km — payout uses visit route.",
      gps_track_ineligible: "GPS track insufficient — payout uses visit route.",
      gps_track_unavailable: "No GPS track — payout uses completed visits.",
      gps_partial_coverage: "GPS covers only part of the shift — check track quality.",
      gps_low_coverage: "GPS coverage below 70% — payout by visits (GPS insufficient).",
      gps_low_coverage_partial_payout:
        "Partial GPS coverage — payout by GPS track (less than full day; check track).",
      gps_snap_loop_collapse:
        "GPS collapsed to a short loop (home→…→home) — auto visit payout blocked; manual review required.",
      compensation_review_required: "Compensation not calculated automatically — manager review required.",
      gps_raw_payout_after_short_snap: "OSRM route truncated — compensation used raw GPS track.",
      gps_ended_before_last_visit: "GPS ended before last visit — payout uses visit route.",
      gps_ended_early_partial_payout: "GPS ended early — payout still uses available track.",
      gps_implausibly_short_vs_visits: "GPS km much lower than visit route — payout uses visits.",
      gps_implausibly_long_vs_visits: "GPS km much higher than visit route — payout uses visits.",
      planned_km_implausibly_large: "Planned distance looks wrong (>500 km) — do not use as norm.",
      planned_km_vs_fact_outlier: "Planned distance many times higher than fact — plan marked suspicious.",
      fuel_price_missing_for_uah_estimate:
        "Set UAH/L price in profile to estimate compensation in ₴. Km already saved.",
      report_stale: "Saved km differs from current source — click Recalculate.",
    },
  },
  visitsTeam: {
